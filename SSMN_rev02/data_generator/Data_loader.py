...
from my_utils.mat2csv import get_data_csv
from my_utils.data_preprocess import my_normalization1, my_normalization3, add_noise
...
def sample_shuffle(data):
    ...
    """
    np.random.seed(0)  # freeze the seed
...
class data_generate:
    def __init__(self):
        ...
        self.sq7_39 = [sq7_39_0, sq7_39_1]  # 0, 1 indicates the file, not the load or sth.
    ...
    def Cs_4way(self, way=3, examples=50, split=30, shuffle=True,
        ...
        :param shuffle:
        :param way:
        :param examples: number of samples under each speed, 4 kinds.
        :param split:
        :param data_len:
        :param normalize:
        :param label:
    ...
    def EB_3_13way(self, way, order=1, examples=100, split=30, shuffle=False,
                   data_len=1024, normalize=True, label=False):
        """
        :param shuffle:
