"""
case 数据集
0 1 2 3分别代表对轴承施加的由轻到重的载荷程度，轴承转速分别对应1797、1772、1750、1730 rpm
for 3-way or 4-way classification, only with fault diameter of 0.007 inches
fs = 12kHz

===========
2021-1-20，代码调整以在台式机上运行。
"""
...
# for 4-way classification, 0,1,2,3 denotes the load.
